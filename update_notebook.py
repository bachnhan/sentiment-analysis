...
nb["cells"][33]["source"] = [
    ...
    "   Fine-tuned RoBERTa reigns supreme. Because it was pretrained on hundreds of millions of actual tweets and custom-adapted for sentiment, it masters contextual slang, abbreviations, and informal emoji syntax far better than any other model.\n",
    "\n",
